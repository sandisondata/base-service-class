...
export declare abstract class RepositoryService<PrimaryKey extends Record<string, string | number>, Data extends Record<string, any>, System extends Record<string, any> = Record<string, never>> {
